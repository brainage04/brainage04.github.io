...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A modern Fabric template with server-only, client-only, and combined variants, tests, GameTests, and release automation.',
  ...
  },
  {
    ...
    description: 'A maintained Forge 1.8.9 template with Kotlin, Mixin, MoulConfig, and modern Gradle tooling.',
    technologies: ['Kotlin', 'Java 8', 'Forge', 'GitHub Actions'],
    category: 'templates-starters',
    status: 'template',
  },
  {
